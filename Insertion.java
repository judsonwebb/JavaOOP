/*
Program Name: Insertion
Author: Noah Webb
Class: AP Computer Science
Date: 03/05/17
Program description: Insertion orders an array using the insertion method.
What I learned from this program: How to sort with the insertion method.
Difficulties: Originally wrote this where insert would swap with each subsequent
number until it was in the right place, but it was overly complex and wasteful.
*/
